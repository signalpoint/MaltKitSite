      ...
      <div class="row">
        ...
        <div class="col-2">
          ...
          <div id="canvasControls" class="btn-group btn-group-vertical" role="group" aria-label="Canvas controls">
            ...
            <!-- EDIT -->
            <button type="button" class="btn btn-light" data-op="edit" title="Edit">
            ...
            <!-- POINTER -->
            <button type="button" class="btn btn-light" data-op="pointer" title="Use Pointer">
        ...
        <div class="col-10">
          ...
          <div id="canvasControlPanes">
            <div class="canvas-control-pane d-none" data-op="edit">edit</div>
            <div class="canvas-control-pane d-none" data-op="toggleGrid">grid</div>

            <!-- POINTER-->
            <div class="canvas-control-pane d-none" data-op="pointer">

              <div id="pointerEntityPane"></div>

            </div>

            <div class="canvas-control-pane d-none" data-op="drawCircle">circle</div>
            <div class="canvas-control-pane d-none" data-op="drawRectangle">rectangle</div>
            <div class="canvas-control-pane d-none" data-op="drawPolygon">polygon</div>
          </div>
